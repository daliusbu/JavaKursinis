...
@WebServlet("/routesByDriverDate")
public class RoutesByDriverDateSrvl extends HttpServlet {
    @Override
...
//        int returnOdo = Integer.parseInt(req.getParameter("returnOdo"));
        ...
        req.getRequestDispatcher("WEB-INF/routesByDriverDate.jsp").forward(req, resp);
